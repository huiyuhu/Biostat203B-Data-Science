...
```{r}
totpay <- readRDS("LAPayrolls/totpay.rds")
ui <- fluidPage(
...
```{r}
highp <- readRDS("LAPayrolls/highpay.rds")
ui <- fluidPage(
...
```{r}
meanp <- readRDS("LAPayrolls/meanpay.rds")
medp <- readRDS("LAPayrolls/medpay.rds")
ui <- fluidPage(
...
```{r}
 cost <- readRDS("LAPayrolls/cost.rds")
ui <- fluidPage(
...
https://huiyuhu.shinyapps.io/LAPayrolls
