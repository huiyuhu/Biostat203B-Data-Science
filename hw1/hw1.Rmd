...
```
   ...
   * $Code:$
```{bash}
awk '{OFS = ","} {print $1, $2, $3, $4, $5, $6}' /home/m280-data/hw1/merge-geno.fam | sed 's/T2DG//g' | awk -F, -v sex="" '{OFS = ","} {if ($5 == 1) sex = "M"; else sex = "F"} {print $1,$2,$3,$4, sex,$6}' | awk -F, '{OFS=","} { for (i = 1; i <= NF; i++) {$i = ($i == 0 ? "" : $i)}; print }'  > /home/huiyuhu/biostat-m280-2018-winter/hw1/mendel_ped.txt
...
```{r}
  ...
  result <- paste(round(sum1/rep, 4), round(sum2/rep, 4), sep = " ")
  #return(result)
  result
```
