...
gg3 <- ggplot() +
  ...
  geom_label(label = c("5","1","3","2","4"), 
             aes(x = as.Date(c('2001-1-1', '2001-9-30', 
                               '2004-7-1', '2004-12-1', '2008-1-1')), 
...
gg4
```
* The table and plot showed the seasonal effect on the flight traffic in LAX. Winter quater had lowest traffic and summer and fall quater had busies traffic. 
...
```
  * The Sat and Sun had less traffic.
